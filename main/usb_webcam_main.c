 ...
 * Uses the simple frame info structure compatible with the UVC component
 *******************************************************************/
...
static const struct {
    ...
    int height;
    int rate;
} UVC_FRAMES_INFO[][UVC_FRAMES_COUNT] = {
    {
        // MJPEG Format with multiple resolution options
        {640, 480, 15},      // VGA @ 15fps - good balance
        {800, 600, 15},      // SVGA @ 15fps - higher quality
        {1280, 720, 10},     // HD @ 10fps - HD quality
        {1920, 1080, 5},     // Full HD @ 5fps - maximum quality
    }
};
#else
...
static const struct {
    ...
    {
        {800, 600, 15},      // SVGA @ 15fps - default single mode
    }
};
#endif
